...
<script lang="ts">
    ...
    // Redirect to /post if the user is already logged in
    onMount(() => {
...
<p
    class="h-[4vh] hover:underline mt-2 ml-5 cursor-pointer text-subText"
    on:click={() => {
        goto("/search");
    }}
>
...
<div class="h-[92vh] w-full flex flex-col gap-5 items-center justify-center">
    <button
